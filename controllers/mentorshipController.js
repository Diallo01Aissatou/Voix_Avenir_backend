...
exports.getSentRequests = async (req, res) => {
  try {
    ...
    const requestsWithPhotoUrl = requests.map(request => {
      ...
      if (requestObj.mentore?.photo) requestObj.mentore.photo = fixPhotoUrl(requestObj.mentore.photo);
      if (requestObj.mentoree?.photo) requestObj.mentoree.photo = fixPhotoUrl(requestObj.mentoree.photo);
      return requestObj;
    });
