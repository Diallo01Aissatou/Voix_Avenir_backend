...
exports.getTestimonials = async (req, res) => {
  try {
    ...
    const testimonialsWithPhotoUrl = mentoreesTestimonials.map(testimonial => {
      ...
      if (testimonialObj.author?.photo && !testimonialObj.author.photo.startsWith('http') && !testimonialObj.author.photo.startsWith('data:') && !testimonialObj.author.photo.startsWith('data:') && !testimonialObj.author.photo.startsWith('/api/')) {
